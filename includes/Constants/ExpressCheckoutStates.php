<?php
/**
 * Class ExpressCheckoutStates
 *
 * Provides a map between WC states and Google & Apple Pay states.
...
class ExpressCheckoutStates {
	...
	const STATES = [
		...
		// China.
		'CN' => [
			'CN1'  => [ 'Yunnan', 'Yunnan Sheng', '云南省' ],
			'CN2'  => [ 'Beijing', 'Beijing Shi', '北京市' ],
			'CN3'  => [ 'Tianjin', 'Tianjin Shi', '天津市' ],
			'CN4'  => [ 'Hebei', 'Hebei Sheng', '河北省' ],
			'CN5'  => [ 'Shanxi', 'Shanxi Sheng', '山西省' ],
			'CN6'  => [ 'Neimenggu', 'Neimenggu Zizhiqu', '内蒙古' ],
			'CN7'  => [ 'Liaoning', 'Liaoning Sheng', '辽宁省' ],
			'CN8'  => [ 'Jilin', 'Jilin Sheng', '吉林省' ],
			'CN9'  => [ 'Heilongjiang', 'Heilongjiang Sheng', '黑龙江省' ],
			'CN10' => [ 'Shanghai', 'Shanghai Shi', '上海市' ],
			'CN11' => [ 'Jiangsu', 'Jiangsu Sheng', '江苏省' ],
			'CN12' => [ 'Zhejiang', 'Zhejiang Sheng', '浙江省' ],
			'CN13' => [ 'Anhui', 'Anhui Sheng', '安徽省' ],
			'CN14' => [ 'Fujian', 'Fujian Sheng', '福建省' ],
			'CN15' => [ 'Jiangxi', 'Jiangxi Sheng', '江西省' ],
			'CN16' => [ 'Shandong', 'Shandong Sheng', '山东省' ],
			'CN17' => [ 'Henan', 'Henan Sheng', '河南省' ],
			'CN18' => [ 'Hubei', 'Hubei Sheng', '湖北省' ],
			'CN19' => [ 'Hunan', 'Hunan Sheng', '湖南省' ],
			'CN20' => [ 'Guangdong', 'Guangdong Sheng', '广东省' ],
			'CN21' => [ 'Guangxi', 'Guangxi Zhuangzuzizhiqu', '广西' ],
			'CN22' => [ 'Hainan', 'Hainan Sheng', '海南省' ],
			'CN23' => [ 'Chongqing', 'Chongqing Shi', '重庆市' ],
			'CN24' => [ 'Sichuan', 'Sichuan Sheng', '四川省' ],
			'CN25' => [ 'Guizhou', 'Guizhou Sheng', '贵州省' ],
			'CN26' => [ 'Shaanxi', 'Shaanxi Sheng', '陕西省' ],
			'CN27' => [ 'Gansu', 'Gansu Sheng', '甘肃省' ],
			'CN28' => [ 'Qinghai', 'Qinghai Sheng', '青海省' ],
			'CN29' => [ 'Ningxia', 'Ningxia Huizuzizhiqu', '宁夏' ],
			'CN30' => [ 'Macau', 'Macau', '澳门' ],
			'CN31' => [ 'Xizang', 'Xizang Zizhiqu', '西藏' ],
			'CN32' => [ 'Xinjiang', 'Xinjiang Weiwuerzizhiqu', '新疆' ],
			// [ 'Taiwan', 'Taiwan', '台湾' ],
