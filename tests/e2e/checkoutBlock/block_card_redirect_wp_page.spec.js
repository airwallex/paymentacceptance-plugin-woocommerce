...
test.describe('Redirect card element - Block checkout page - Auto capture - WP page payment template', () => {
...
test.describe('Redirect card element - Block checkout page - Manual capture - WP page payment template', () => {
