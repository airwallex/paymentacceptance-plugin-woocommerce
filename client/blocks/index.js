...
const CurrencySwitchingDetail = ({ cart, extensions }) => {
    ...
    return (
        <div style={{ display: showElement ? "flex" : "none" }}>
            ...
            <div className="wc-airwallex-currency-switching-container">
                <div className="wc-airwallex-currency-switching-conversion-rate">
                    ...
                    <div className="wc-airwallex-currency-switching-convert-text">
                        {conversionRate}
                    </div>
                </div>
                <div className="wc-airwallex-currency-switching-converted-amount">
                    {convertedAmount}
                </div>
            </div>
        </div>
